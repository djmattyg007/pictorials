function AlbumGallery(container, albums, loader, templater, notificationManager, albumGetSortedFilesUrl)
{
    ...
    _startGalleria: function(galleryData) {
        ...
        var moreLoad = function() {
            ...
            if (curPage < totalPages) {
                setTimeout(moreLoad, curPage <= 3 ? 2500 : (curPage <= 6 ? 4000 : 6000));
            }
        };
